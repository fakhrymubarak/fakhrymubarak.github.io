...
const PomoDojoPrivacyPage: React.FC = () => {
  return (
    <>
      <SEO
        title="Privacy Policy - PomoDojo"
        description="Privacy policy for the PomoDojo - Pomodoro Timer application."
        url="https://fakhrymubarak.github.io/privacy/pomodojo"
      />
      <div
        style={{
...
export default PomoDojoPrivacyPage;
