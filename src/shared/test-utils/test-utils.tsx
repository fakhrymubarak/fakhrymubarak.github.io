...
jest.mock('@presentation/components/sections/IntroSection', () => ({
  __esModule: true,
...
jest.requireActual('@presentation/components/sections/ProjectsSection');
jest.mock('@presentation/components/sections/ProjectsSection', () => {
  const actual = jest.requireActual(
    '@presentation/components/sections/ProjectsSection'
  );
  return {
    __esModule: true,
...
jest.mock('@presentation/components/sections/ExperienceSection', () => ({
  __esModule: true,
  default: () => <div data-testid="experience-section">Experience Section</div>,
}));

jest.mock('@presentation/components/sections/FooterSection', () => ({
  __esModule: true,
  default: () => <div data-testid="footer-section">Footer Section</div>,
}));

// Mock SEO and SkipLink components
jest.mock('@presentation/components/SEO', () => ({
  __esModule: true,
  default: () => <div data-testid="seo">SEO</div>,
}));

jest.mock('@presentation/components/ui/SkipLink', () => ({
  __esModule: true,
