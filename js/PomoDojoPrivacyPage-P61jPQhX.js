import{j as e}from"./index-DHZbvGa5.js";import{S as o}from"./chunk-BmNqq2ZH.js";import"./chunk-DavUf6mE.js";import"./chunk-BNRFPHjS.js";import"./chunk-Cj4qlto9.js";const i=`<style>
  h1 { font-size: 2rem; margin: 0 0 1rem; line-height: 1.3; color: #111; }
  strong { display: block; margin: 1.5rem 0 0.75rem; font-size: 1.1rem; }
  p { margin: 0 0 1rem; line-height: 1.6; color: #222; }
  ul { margin: 0.5rem 0 1rem 1.5rem; line-height: 1.6; color: #222; }
...
<p>This privacy policy is applicable to the PomoDojo - Pomodoro Timer app (hereinafter referred to
    as "Application") for mobile devices, which was developed by Fakhry Mubarak (hereinafter
    referred to as "Service Provider") as a a Free service. This service is provided "AS IS".</p>
<br><strong>What information does the Application obtain and how is it used?</strong><br><strong>What
    information do users provide to the Application?</strong>
...
<br><strong>What information does the Application collect automatically?</strong>
<p>In addition, the Application may collect certain information automatically, including, but not
    ...
    browsers you use, and information about the way you use the Application.</p><br><strong>Does the
    Application collect precise real time location information of the device?</strong>
<p>This Application does not gather precise information about the location of your mobile
    device.</p>
<div style="display: none;"><p>This Application collects your device's location, which helps the
...
<br><strong>Does the Application use Artificial Intelligence (AI) technologies?</strong>
<p>The Application does not use Artificial Intelligence (AI) technologies to process your data or
    provide features.</p>
<div style="display: none;"><p>The Application uses Artificial Intelligence (AI) technologies to
    enhance user experience and provide certain features. The AI components may process user data in
    the following ways:</p>
    <ul>
        <li>Personalized Content: AI may analyze your usage patterns to deliver content tailored to
            your preferences and behavior.
        </li>
        <li>Recommendations: AI may suggest features, services, or content based on your
            interactions within the Application.
        </li>
        <li>Automated Functionalities: Certain app features may be powered by AI to automate tasks
            or improve efficiency.
        </li>
        <li>Data Protection: All AI processing is performed in accordance with this privacy policy
            and applicable laws, ensuring your data is handled securely and responsibly.
        </li>
    </ul>
</div>
<br><strong>Do third parties see and/or have access to information obtained by the
    Application?</strong>
...
<p>You can halt all collection of information by the Application easily by uninstalling the
    ...
    mobile device or via the mobile application marketplace or network.</p><br><strong>What is the
    data retention policy and how can you manage your information?</strong>
<p>The Service Provider will retain User Provided data for as long as you use the Application and
    ...
    contact them at fakhrymubarak@gmail.com and we will respond in a reasonable time. Please note
    that some or all of the User Provided Data may be required in order for the Application to
    function properly.</p><br><strong>How does the Application address children's privacy?</strong>
...
<div><br>
    <p>The Application does not address anyone under the age of 13. The Service Provider does not
        ...
        information, please contact the Service Provider (fakhrymubarak@gmail.com) so that they will
        be able to take the necessary actions.</p></div><!----><br><strong>How is your information
    kept secure?</strong>
<p>The Service Provider are concerned about safeguarding the confidentiality of your information.
    ...
    potential security breaches.</p><br><strong>How will you be informed of changes to this Privacy
    Policy?</strong>
...
<p>This privacy policy is effective as of 2025-12-16</p><br><strong>How do you give your
    consent?</strong>
<p>By using the Application, you are giving your consent to the Service Provider processing of your
    ...
    information.</p><br><strong>How can you contact us?</strong>
<p>If you have any questions regarding privacy while using the Application, or have questions about
    the practices, please contact the Service Provider via email at fakhrymubarak@gmail.com.</p>
<hr>
<p>This privacy policy page was generated by <a
        href="https://app-privacy-policy-generator.nisrulz.com/" target="_blank"
        rel="noopener noreferrer">App Privacy Policy Generator</a></p>`,l=()=>e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Privacy Policy - PomoDojo",description:"Privacy policy for the PomoDojo - Pomodoro Timer application.",url:"https://fakhrymubarak.github.io/privacy/pomodojo"}),e.jsx("div",{style:{fontFamily:"'Helvetica Neue', Helvetica, Arial, sans-serif",width:"80%",margin:"5rem auto 2rem",padding:"1em"},dangerouslySetInnerHTML:{__html:i}})]});export{l as default};
